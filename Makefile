...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/simple_event_bus.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ simple_event_bus
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
check: lint install coverage clean-test ## run all import before commit
...
requirements: ## make requirements.txt
	...
	pipreqs . --encoding utf8  --pypi-server https://pypi.douban.com/simple/ --force
